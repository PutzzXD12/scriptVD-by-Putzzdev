-- ============================================
-- ANCH-HAX | Violence District Script
-- Decoded & Cleaned Version (Sama persis dengan asli)
-- ============================================
...
-- GUI Frame (sama persis dengan asli)
local main = Instance.new("Frame")
main.Name = "Main"
main.Size = UDim2.new(0, 190, 0, 380)
main.Position = UDim2.new(0.5, -95, 0.5, -190)
...
TweenService:Create(main, TweenInfo.new(0.45, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
    ...
    Position = UDim2.new(0.5, -95, 0.5, -190)
}):Play()
...
local function makeButton(text, parent, color)
    ...
    b.MouseLeave:Connect(function()
        TweenService:Create(b, TweenInfo.new(0.12), {BackgroundColor3 = color or Color3.fromRGB(44, 44, 44)}):Play()
    end)
    return b
end
...
print("ANCH-HAX: Generators found:", #gens)
print("ANCH-HAX: Hooks found:", #hooks)
...
-- SECTION COMBAT
makeButton("━━━ COMBAT ━━━", scroll, Color3.fromRGB(80, 80, 100))
...
makeButton("ShiftLock (8s)", scroll).MouseButton1Click:Connect(function()
...
makeButton("Smart Hitbox", scroll).MouseButton1Click:Connect(function()
    for _, pl in ipairs(Players:GetPlayers()) do
        local nm = string.lower(pl.Name or "")
...
makeButton("Anti Stun", scroll).MouseButton1Click:Connect(function()
    local hum = player.Character and player.Character:FindFirstChildOfClass("Humanoid")
...
-- Anti Damage (fitur unggulan)
makeButton("Anti Damage", scroll).MouseButton1Click:Connect(function()
            ...
            if hum2.Health < lastHealth then
                ...
                if hrp then
                    ...
                    if nearestKiller then
                        ...
                        dir = dir.Unit
                        escapeCFrame = CFrame.new(hrp.Position + dir * ANTI_DAMAGE_DISTANCE, 
                                                   hrp.Position + dir * ANTI_DAMAGE_DISTANCE + Vector3.new(0, 1, 0))
                    else
                        ...
                        escapeCFrame = CFrame.new(hrp.Position - look.Unit * ANTI_DAMAGE_DISTANCE,
                                                   hrp.Position - look.Unit * ANTI_DAMAGE_DISTANCE + Vector3.new(0, 1, 0))
                    end
...
-- SECTION VISUAL
makeButton("━━━ VISUAL ━━━", scroll, Color3.fromRGB(80, 80, 100))
...
minimizeBtn.MouseButton1Click:Connect(function()
    ...
    if isMin then
        ...
        TweenService:Create(main, TweenInfo.new(0.25), {Size = UDim2.new(0, 190, 0, 380)}):Play()
        scroll.Visible = true
        title.Text = "ANCH HAX"
    end
end)
