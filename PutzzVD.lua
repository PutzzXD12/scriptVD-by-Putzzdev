...
-- ================== ESP SYSTEM (BOX HIJAU + LINE PUTIH) ==================
local espEnabled = true -- Default ON
local espBoxes = {}
local espTexts = {}
local espLines = {}
local espBoxColor = Color3.fromRGB(0, 255, 0) -- Hijau untuk box
local espLineColor = Color3.fromRGB(255, 255, 255) -- Putih untuk line
        ...
        if char and char:FindFirstChild("HumanoidRootPart") and char:FindFirstChild("Head") then
            ...
            if visible then
                ...
                if espEnabled then
                    ...
                    -- Line (putih dari bawah ke target)
...
print("✅ VD Putzzdev Loaded! - ESP Box Hijau + Line Putih | AntiDamage dari Drip")