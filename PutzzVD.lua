...
-- ESP LANE - Highlight Player/Survivor dengan warna HIJAU MUDA
makeButton("ESP Lane", scroll).MouseButton1Click:Connect(function()
	for _,pl in ipairs(Players:GetPlayers()) do
		if pl ~= player and pl.Character then
			highlights[pl] = createHighlight(pl.Character, Color3.fromRGB(0,255,150))
		end
	end
end)
